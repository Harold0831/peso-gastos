...
export default async function DashboardPage() {
  ...
  // Gastos fijos y Metas tienen su tile aquí ADEMÁS de vivir bajo "Más":
  // el menú es el índice completo, pero ver "3/5 pagados" de un vistazo al
  // abrir la app es justo lo que uno quiere saber sin navegar.
  ...
  return (
    <main className="px-5 pt-safe">
      ...
      {/* Accesos compactos con estado. Duplican dos filas de "Más" a
          propósito: ahí está el índice completo, aquí el vistazo rápido. */}
